...
class TemplateTab extends React.Component {
    ...
    render() {
        ...
        const columns = [
            ...
            {title: '名称',width: '100px',dataIndex: 'name',fixed:'left'},
            {title: '客户负责人',width: '90px',dataIndex: 'khfzr',fixed:'left'},
            {title: '客户负责人电话',width: '90px',dataIndex: 'khphone'},
            {title: '业务负责人',width: '90px',dataIndex: 'ywfzr',fixed:'left'},
            {title: '业务负责人电话',width: '90px',dataIndex: 'ywphone'},
            {title: '地址',minWidth: '200px',dataIndex: 'address'}
        ];
        //行内操作
        const action = [
            {title:'修改',onClick:this.handleUpdateBtnClick},
            {title:'客户联系人',onClick:this.handleContactsBtnClick},
