...
class Permission extends React.Component {
    ...
    handleUpdateBtnClick = (record) => {
      let id = record.id;
      NHFetch('/customer-linkman/getById', 'GET',{id:id})
          .then(res => {
              if(res){
    ...
    //删除操作
    handleDelete = (ids) => {
        NHFetch('/customer-linkman/delete' , 'POST' , ids)
            .then(res => {
                if (res) {
    ...
    handleSaveAdd = (stopLoading) => {
        this.refs.nhAddForm.validateFields((err, formData) => {
            ...
            formData.kaid=this.props.id;
            NHFetch('/customer-linkman/add' , 'POST' , formData)
                .then(res => {
                    stopLoading();
                    if (res) {
    ...
    handleSaveUpdate = (stopLoading) => {
        this.refs.nhUpdateForm.validateFields((err, formData) => {
            ...
            formData.kaid = this.state.formInitData.kaid;
            NHFetch('/customer-linkman/update' , 'POST' , formData)
                .then(res => {
                    stopLoading();
                    if (res) {
